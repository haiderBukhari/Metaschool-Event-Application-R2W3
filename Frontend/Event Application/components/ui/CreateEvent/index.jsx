...
const CreateEvent = () => {
    ...
    return (
        <div className='max-w-screen min-h-screen py-10 overflow-hidden' style={{ backgroundColor: "#f4f5f6" }}>
            ...
            <div className='rounded-lg shadow-md min-h-[600px] max-w-[800px] m-auto p-5 flex flex-row flex-wrap justify-between bg-white'>
                ...
                <div style={{border: "1px solid #ccc", borderRadius: "30px", maxWidth: "250px", textAlign: "center", padding: "8px", margin: "20px 0"}}>
                    ...
                    <div className="flex justify-center items-center mt-7">
                        ...
                        <input onChange={(e)=>{setDate(e.target.value)}} style={{ border: "1px solid #ccc" }} className="w-[100%] p-2 flex-1" type="date" placeholder="Pick Event Date" />
                    </div>
                    <div className="flex justify-center items-center mt-7">
                        <label className="mr-2 "> Event Time: </label>
                        <input onChange={(e)=>{setTime(e.target.value)}} style={{ border: "1px solid #ccc" }} className="w-[100%] p-2 flex-1" type="time" placeholder="Pick Event Time" />
                    </div>
                        ...
                        {!eventImage ? (
                            <>
                                ...
                                <div className="grid w-full max-w-sm items-center gap-1.5 pt-2">
                                    <label className='font-bold font-serif text-xl' htmlFor="picture">Upload Event Thumbnail</label>
                                    <Input onChange={ImageUpload} id="picture" type="file" accept="image/*" />
                                </div>
                            </>
                        ) : (
                            <div className="relative">
                                ...
                                src={eventImage}
                                    alt="events-background"
                                />
                                <X onClick={() => {setEventImage(null)}} style={{backgroundColor: "rgba(100, 0, 0,0.5)", color: "#ffffff", borderRadius: "50%", padding:"4px", top: "-14px", right: "-14px", cursor: "pointer"}} className="absolute"/>
                            </div>
                        )}
